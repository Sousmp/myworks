    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".menu__icon")) document.addEventListener("click", (function(e) {
                ...
                if (bodyLockStatus && !e.target.closest(".menu__body") && !e.target.closest(".menu__icon") && document.documentElement.classList.contains("menu-open")) menuClose();
            }));
        }
        function menuClose() {
            bodyUnlock();
            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        const offsetTop = gotoLink.dataset.gotoTop ? parseInt(gotoLink.dataset.gotoTop) : 50;
        ...
        if (phoneInput) {
            const iti = window.intlTelInput(phoneInput, {
                ...
                geoIpLookup: function(callback) {
                    fetch("https://ipinfo.io?token=7e5d733bb1b556").then((response => response.json())).then((data => callback(data.country))).catch((() => callback("ch")));
                },
            ...
            function updateMask() {
                ...
                if (placeholder) {
                    const digitsPlaceholder = placeholder.replace(/\D/g, "");
                    const mask = "9".repeat(digitsPlaceholder.length);
                    Inputmask({
                        mask
                    }).mask(phoneInput);
                }
            ...
            if (form) {
                ...
                function checkInputs() {
                    ...
                    submitButton.disabled = !(allFilled && isPhoneValid);
                }
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (localStorage.getItem("cookiesAccepted") === "true") popup.style.display = "none";
        }));
        window["FLS"] = true;
        isWebp();
        menuInit();
