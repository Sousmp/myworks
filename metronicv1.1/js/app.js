(() => {
    ...
    if (isMobile.any()) {
        ...
        let langButton = document.querySelector(".header__lang-active");
        let langList = document.querySelector(".header__dropdown");
        langButton.addEventListener("click", (function() {
            langList.classList.toggle("_open");
        }));
    ...
    document.addEventListener("click", (e => {
        if (menuBody.classList.contains("_open") && !e.target.closest(".menu__icon") && !e.target.closest(".menu__body")) menuBody.classList.remove("_open");
    }));
    window["FLS"] = true;
    isWebp();
    spollers();
