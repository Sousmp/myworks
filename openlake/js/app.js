(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            new core(".drops__swiper", {
                ...
                speed: 800,
                scrollbar: {
                    el: ".drops__pagination",
                    draggable: true
                },
                navigation: {
                    nextEl: ".drops__arow-right",
                    prevEl: ".drops__arow-left"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1
            ...
            new core(".browse__swiper", {
                ...
                speed: 800,
                scrollbar: {
                    el: ".browse__pagination",
                    draggable: true
                },
                navigation: {
                    nextEl: ".browse__arow-right",
                    prevEl: ".browse__arow-left"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1.2
    ...
    da.init();
    const searchBtn = document.querySelector(".header__input-svg");
    const searchInput = document.querySelector(".header__input");
    const searchLogo = document.querySelector(".header__logo");
    const searchSearch = document.querySelector(".header__search");
    if (searchBtn && searchInput) searchBtn.addEventListener("click", (function() {
        searchInput.classList.toggle("_active");
        searchLogo.classList.toggle("_active");
        searchSearch.classList.toggle("_active");
    }));
    const exploreBtn = document.querySelector(".explore__btn");
    const exploreSpoller = document.querySelector(".explore__spoller-mob");
    if (exploreBtn) exploreBtn.addEventListener("click", (function() {
        exploreSpoller.classList.toggle("_active");
    }));
    const menuBurger = document.querySelector(".menu__icon-box");
    const menuBody = document.querySelector(".menu__body");
    if (menuBurger) menuBurger.addEventListener("click", (function() {
        document.body.classList.toggle("_lock");
        menuBurger.classList.toggle("_active");
        menuBody.classList.toggle("_active");
        exploreSpoller.classList.remove("_active");
    }));
    const topProcent = document.querySelectorAll(".top__procent");
    if (topProcent) topProcent.forEach((e => {
        let content = e.innerHTML;
        if (content.length > 1) {
            let symbol = content.slice(0, 1);
            if ("-" == symbol) e.classList.add("_red"); else e.classList.add("_green");
        }
    }));
    window["FLS"] = true;
    isWebp();
