(() => {
    ...
    function addTouchClass() {
        if (!isMobile.any()) document.documentElement.classList.add("pc");
        if (isMobile.any()) document.documentElement.classList.add("mob");
    }
    function fullVHfix() {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".gallery__swiper")) new swiper_core_Swiper(".gallery__swiper", {
            modules: [ Navigation, Scrollbar, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    da.init();
    var imgElements = document.querySelectorAll("img.img-svg");
    imgElements.forEach((function(imgElement) {
        var imgClass = imgElement.getAttribute("class");
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                ...
                if (typeof imgClass !== "undefined") svgElement.setAttribute("class", imgClass + " replaced-svg");
                svgElement.removeAttribute("xmlns:a");
                if (!svgElement.getAttribute("viewBox") && svgElement.getAttribute("height") && svgElement.getAttribute("width")) svgElement.setAttribute("viewBox", "0 0 " + svgElement.getAttribute("height") + " " + svgElement.getAttribute("width"));
    ...
    slides.forEach((el => {
        el.addEventListener("click", (function() {
            var isActive = el.classList.contains("show-button");
            if (!isActive) {
    ...
    if (currentPath.charAt(0) === "/") currentPath = currentPath.slice(1);
    var menuLinks = document.querySelectorAll(".header__link");
    menuLinks.forEach((function(link) {
        var linkHref = link.getAttribute("href");
        if (linkHref.charAt(0) === "/") linkHref = linkHref.slice(1);
        if (linkHref === currentPath) link.classList.add("header__link-active");
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
